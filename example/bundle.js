...
},{"../compiler":10,"../config":12,"../directives/internal":19,"../fragment/factory":41,"../parsers/directive":51,"../parsers/expression":52,"../parsers/path":53,"../parsers/template":54,"../parsers/text":55,"../util":63}],5:[function(require,module,exports){
'use strict';
...
},{"../compiler":10,"../util":63}],6:[function(require,module,exports){
'use strict';
...
},{"./config":12,"./util":63}],7:[function(require,module,exports){
/**
...
},{"../config":12,"../directives/internal/prop":20,"../parsers/directive":51,"../parsers/path":53,"../util":63}],9:[function(require,module,exports){
'use strict';
...
},{"../directives/internal":19,"../directives/public":29,"../parsers/directive":51,"../parsers/template":54,"../parsers/text":55,"../util":63,"./compile-props":8}],10:[function(require,module,exports){
'use strict';
...
},{"../parsers/template":54,"../util":63}],12:[function(require,module,exports){
'use strict';
...
},{"./parsers/expression":52,"./util":63,"./watcher":67}],14:[function(require,module,exports){
'use strict';
...
},{"../../fragment/factory":41,"../../util":63,"../public/if":28}],16:[function(require,module,exports){
'use strict';
...
},{"../../parsers/template":54,"../../util":63}],19:[function(require,module,exports){
'use strict';
...
},{"../../util":63,"../internal/style":21}],24:[function(require,module,exports){
'use strict';
...
},{"../../fragment/factory":41,"../../util":63}],27:[function(require,module,exports){
'use strict';
...
},{"../../fragment/factory":41,"../../util":63}],29:[function(require,module,exports){
// text & html
'use strict';
...
},{"../../../util":63,"./checkbox":30,"./radio":32,"./select":33,"./text":34}],32:[function(require,module,exports){
'use strict';
...
if ("development" !== 'production') {
  module.exports = {
    bind: function bind() {
      require('../../util').warn('v-ref:' + this.arg + ' must be used on a child ' + 'component. Found on <' + this.el.tagName.toLowerCase() + '>.');
    }
  };
}

},{"../../util":63}],37:[function(require,module,exports){
'use strict';
...
},{"../util":63}],44:[function(require,module,exports){
'use strict';
...
},{"../util":63}],47:[function(require,module,exports){
'use strict';
...
},{"../compiler":10,"../observer":50,"../observer/dep":49,"../util":63,"../watcher":67}],48:[function(require,module,exports){
'use strict';
...
},{"../util":63,"./array":48,"./dep":49}],51:[function(require,module,exports){
'use strict';
...
},{"../cache":7,"../util":63,"./path":53}],53:[function(require,module,exports){
'use strict';
...
},{"../cache":7,"../util":63}],54:[function(require,module,exports){
'use strict';
...
},{"./index":63}],60:[function(require,module,exports){
/**
...
},{"../config":12}],61:[function(require,module,exports){
'use strict';
...
},{"../config":12,"../transition":56,"./index":63}],62:[function(require,module,exports){
...
},{"../config":12,"./index":63}],66:[function(require,module,exports){
'use strict';
...
},{"./batcher":6,"./config":12,"./observer/dep":49,"./parsers/expression":52,"./util":63}],68:[function(require,module,exports){
'use strict';

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

var _sampleVue10 = require('../.sample/vue1.0');

var _sampleVue102 = _interopRequireDefault(_sampleVue10);

var _lib = require('../lib');

var _lib2 = _interopRequireDefault(_lib);

var childComponent = _sampleVue102['default'].extend({
  data: function data() {
...
_sampleVue102['default'].use(_lib2['default']);
var vm = new _sampleVue102['default']({
  el: '#root',
  components: { childComponent: childComponent }
});

},{"../.sample/vue1.0":66,"../lib":69}],69:[function(require,module,exports){
'use strict';
...
function mergeArray(targetArray, defaultArray) {
  return targetArray.concat(defaultArray.filter(function (element) {
    var result = false;
...
var defaultProps = [itemGenerate('text', {
  minLength: 5,
  maxLength: 15
}), itemGenerate('email', {
  isEmail: true
